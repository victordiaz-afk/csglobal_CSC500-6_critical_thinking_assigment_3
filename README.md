...
This project benchmarks four sorting algorithms—**Bubble Sort**, **Selection Sort**, **Insertion Sort**, and **Merge Sort**—across different dataset sizes and distributions. It measures execution time, saves results to CSV/Excel, and generates grouped bar charts for visual comparison.
...
- Outputs:
  ...
  - `sorting_benchmark_results.xlsx`
